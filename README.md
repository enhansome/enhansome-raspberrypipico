...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,969 | 🐛 324 | 🌐 C | 📅 2026-09-21 - Official Raspberry Pi Pico SDK repository.
* [Pico Examples](https://github.com/raspberrypi/pico-examples) ⭐ 3,915 | 🐛 154 | 🌐 C | 📅 2026-09-19 - Raspberry Pi Pico SDK examples.
* [Resetting Pico Flash Memory](https://github.com/raspberrypi/pico-examples/blob/master/flash/nuke/nuke.c) ⭐ 3,915 | 🐛 154 | 🌐 C | 📅 2026-09-19 - 'There is no way to brick the board through software. However, there are some circumstances where you might want to make sure your Flash memory is empty.'
...
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,248 | 🐛 19 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
* [Pico MicroPython Examples](https://github.com/raspberrypi/pico-micropython-examples) ⭐ 1,144 | 🐛 25 | 🌐 Python | 📅 2025-03-18 - Raspberry Pi Pico MicroPython examples.
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 999 | 🐛 30 | 🌐 C++ | 📅 2026-09-18 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
