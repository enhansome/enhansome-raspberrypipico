...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,947 | 🐛 304 | 🌐 C | 📅 2026-08-29 - Official Raspberry Pi Pico SDK repository.
* [Pico Examples](https://github.com/raspberrypi/pico-examples) ⭐ 3,901 | 🐛 155 | 🌐 C | 📅 2026-07-03 - Raspberry Pi Pico SDK examples.
* [Resetting Pico Flash Memory](https://github.com/raspberrypi/pico-examples/blob/master/flash/nuke/nuke.c) ⭐ 3,901 | 🐛 155 | 🌐 C | 📅 2026-07-03 - 'There is no way to brick the board through software. However, there are some circumstances where you might want to make sure your Flash memory is empty.'
* [Pimoroni Pico](https://github.com/pimoroni/pimoroni-pico) ⭐ 1,554 | 🐛 89 | 🌐 C | 📅 2026-08-31 - 'Libraries and examples to support Pimoroni Pico add-ons in C++ and MicroPython.'
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,232 | 🐛 16 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
...
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 984 | 🐛 30 | 🌐 C++ | 📅 2026-08-13 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
...
* [Rust Support Crate](https://github.com/devsnek/pio-rs) ⭐ 193 | 🐛 10 | 🌐 Rust | 📅 2026-07-30 - Rust support crate for Pico's PIO architecture.
