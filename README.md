...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,934 | 🐛 314 | 🌐 C | 📅 2026-08-19 - Official Raspberry Pi Pico SDK repository.
...
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,222 | 🐛 16 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
...
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 974 | 🐛 30 | 🌐 C++ | 📅 2026-08-13 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
