...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,971 | 🐛 324 | 🌐 C | 📅 2026-09-23 - Official Raspberry Pi Pico SDK repository.
* [Pico Examples](https://github.com/raspberrypi/pico-examples) ⭐ 3,918 | 🐛 154 | 🌐 C | 📅 2026-09-23 - Raspberry Pi Pico SDK examples.
* [Resetting Pico Flash Memory](https://github.com/raspberrypi/pico-examples/blob/master/flash/nuke/nuke.c) ⭐ 3,918 | 🐛 154 | 🌐 C | 📅 2026-09-23 - 'There is no way to brick the board through software. However, there are some circumstances where you might want to make sure your Flash memory is empty.'
* [Pimoroni Pico](https://github.com/pimoroni/pimoroni-pico) ⭐ 1,562 | 🐛 97 | 🌐 C | 📅 2026-09-11 - 'Libraries and examples to support Pimoroni Pico add-ons in C++ and MicroPython.'
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,252 | 🐛 19 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
* [Pico MicroPython Examples](https://github.com/raspberrypi/pico-micropython-examples) ⭐ 1,145 | 🐛 25 | 🌐 Python | 📅 2025-03-18 - Raspberry Pi Pico MicroPython examples.
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 1,002 | 🐛 28 | 🌐 C++ | 📅 2026-09-24 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
* [Pico C++ Setup Script](https://github.com/raspberrypi/pico-setup/blob/master/pico_setup.sh) ⭐ 128 | 🐛 8 | 🌐 Shell | 📅 2026-08-17 - A BASH script for setting up the Pico C++ toolchain on your device.
...
* [Rust Support Crate](https://github.com/devsnek/pio-rs) ⭐ 194 | 🐛 7 | 🌐 Rust | 📅 2026-09-01 - Rust support crate for Pico's PIO architecture.
...
* [Buzzer Music](https://github.com/james1236/buzzer_music) ⭐ 111 | 🐛 4 | 🌐 Python | 📅 2024-10-27 - Raspberry Pi Pico / Micropython library to play music through one or more buzzers.
