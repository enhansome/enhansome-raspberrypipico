...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,971 | 🐛 325 | 🌐 C | 📅 2026-09-22 - Official Raspberry Pi Pico SDK repository.
* [Pico Examples](https://github.com/raspberrypi/pico-examples) ⭐ 3,917 | 🐛 154 | 🌐 C | 📅 2026-09-19 - Raspberry Pi Pico SDK examples.
* [Resetting Pico Flash Memory](https://github.com/raspberrypi/pico-examples/blob/master/flash/nuke/nuke.c) ⭐ 3,917 | 🐛 154 | 🌐 C | 📅 2026-09-19 - 'There is no way to brick the board through software. However, there are some circumstances where you might want to make sure your Flash memory is empty.'
...
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,251 | 🐛 19 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
...
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 1,001 | 🐛 28 | 🌐 C++ | 📅 2026-09-23 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
