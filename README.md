...
* [Pico SDK Repo](https://github.com/raspberrypi/pico-sdk) ⭐ 4,962 | 🐛 316 | 🌐 C | 📅 2026-09-11 - Official Raspberry Pi Pico SDK repository.
...
* [Pimoroni Pico](https://github.com/pimoroni/pimoroni-pico) ⭐ 1,558 | 🐛 97 | 🌐 C | 📅 2026-09-11 - 'Libraries and examples to support Pimoroni Pico add-ons in C++ and MicroPython.'
* [Picoprobe](https://github.com/raspberrypi/picoprobe) ⭐ 1,245 | 🐛 19 | 🌐 C | 📅 2026-07-14 - 'It is possible to use one Raspberry Pi Pico to debug another Pico. This is possible via picoprobe, an application that allows a Pico to act as a USB → SWD and UART converter.'
...
* [Picotool](https://github.com/raspberrypi/picotool) ⭐ 994 | 🐛 28 | 🌐 C++ | 📅 2026-09-10 - 'Picotool is a tool for inspecting RP2040 binaries, and interacting with RP2040 devices when they are in BOOTSEL mode.'
